...
//To get the RGB equivalent of any colour, go to http://www.w3schools.com/colors/colors_picker.asp

//create your spreadsheet object by entering the name (optional) and spreadsheet id in the parameters
var ss = new ssc.SpreadSheet("createdSS", "1O4xryyN-bWwGvSG6bJ9e8yDp4dBPEqIjdK5iFdu913M");
return ss.showSpreadSheetProperties();
/**
...
var index = ss.getSheetIndex("Pricess");
...
//To get a range of data.  This method uses "UNFORMATTED_VALUES" as default value render option and "ROWS" as default major dimension, you can change them by adding the 
